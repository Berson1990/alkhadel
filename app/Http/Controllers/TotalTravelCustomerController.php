...
class TotalTravelCustomerController extends Controller {
	...
	{
        return view('totaltravelcustomers.totaltravelcustomers');
	}
    ...
    public function loadTotalTravelCustomersData()
    {
        $input = Request::all();
...
//            ->get();
        ...
        $output = DB::SELECT("select * , Round(Sum(`tblSalesDetails`.`Total`)) as Total , Round(Sum(Carrying)) as Carrying from `tblSales` 
