...
class DiscountNotices extends Model{
     ...
     * @var string
     */
    protected $table = 'tblDiscountNotices';
    ...
    public function validate($inputs){
        ...
        $message = array(
            'CheckNo.required' => trans('discountnotices.required_checkno') ,
            'CheckNo.min' => trans('discountnotices.required_checkno_max_min'),
            'CheckNo.max' => trans('discountnotices.required_checkno_max_min'),
            'NoticeNo.required' => trans('discountnotices.required_noticeno') ,
