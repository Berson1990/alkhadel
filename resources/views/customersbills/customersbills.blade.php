  ...
  <section class="content-header">
        <div class="row">
            <div class="container">
                            ...
                            <h3 class="box-title  title" >تقرير تاجر  ( محلى وصعيد )</h3>
                            </div>
                             <div class="col-lg-4 col-xs-4"></div>
                    </div>
                    </div>
...
/*tr.group:hover {
 ...
 @media print{
#firstPArt{height: 20px; }
 }
 #search-CustomersBills{display: none;}
}

</style>

<script src={{asset("/dist/js/admin/customersbills.js")}} type="text/javascript"></script>
                        ...
                        <div class="box-body">
                            ...
                            <table id="tbl-CustomersReport" dir="rtl" class="table table-bordered table-striped" style="text-align:center">
                                ...
                                <thead>      
                                    ...
                                    <tr>
									  <th class=""> التاريخ</th>		
									  <th class=""> نوع البضاعة</th>		
									  <th class=""> العلامة </th>		
									  <th class=""> اسم التاجر  </th>		
                                    <th class="">اسم الصنف</th>
                                    <th class=""> الوزن</th>
                                    <th class="">العدد</th>
                                    <th class="">السعر</th>
                                    <th class=""> الاجمالى</th>
                                    <th class="hidecombine">اسم المورد  </th>    
