    ...
    <section class="content-header">
        <div class="row">
            ...
            <div  class="col-lg-4  btn  btn-warning box-title-heder">
                <h3 class="box-title  title" >تقرير اجمالى عمولات الموردين الخارجيين  </h3>
            </div>
            <div class="col-lg-4"></div>
        </div>
    </section>
...
@section('content')
    ...
    <!-- products Card-->
    <script src={{asset("/dist/js/admin/forignsupplerstotalcommition.js")}} type="text/javascript"></script>
