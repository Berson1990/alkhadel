...
font-wight:bold;
        ...
        <script src={{asset("/dist/js/admin/customeraccountstatement.js")}} type="text/javascript"></script>
            ...
            <div class="row">
                    ...
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">كشف حساب عميل</h3>
                        </div>
                                    ...
                                    <input name="ToTransDate" id="todate2"  class="form-control datepicker" type="text" placeholder="يوم/شهر/سنة" />
                                      ...
                                      <option data-comm="0" value="0" selected ></option>
                                       ...
                                       @endforeach
                                        ...
                                        <label  style="display:none" id="showcustomer"> </label>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">تقرير كشف حساب عميل</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
