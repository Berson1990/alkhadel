...
$(function () {
    _totalcustomersdata = new totalcustomersdata();
});
    ...
    $.ajax({
        ...
        .done(function (output) {
            ...
            for (var i = 0; i < obj.length; i++) {
                ...
                ToalaKalamia = obj[i].Kalamia / 100 * obj[i].Total;
                ToalaKalamia = Math.round(ToalaKalamia);
                totalbefor += Math.round(obj[i].Total)
                totalafter += ToalaKalamia
                var text = '<tr>'
                    + '<td>' + obj[i].SalesDate + '</td>'
                    + '<td>' + obj[i].SupplierName + '</td>'
                    + '<td>' + Math.round(obj[i].Total) + '</td>'
                    + '<td>' + obj[i].Kalamia + '</td>'
                    + '<td >' + ToalaKalamia + '</td>'
                    + '</tr>';
