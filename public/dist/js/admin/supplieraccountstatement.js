...
function getData(){
    ...
    var z= $('#SupplierIDas option:selected').html();
        $("#showsupplier").text("اسم المورد :"+z);
 ...
 var t = $('#tbl-accountstatement').DataTable();
    ...
    catch(ex)
    {
        ...
        function PrintAS(){
            ...
            $("#SupplierIDas_chosen").css("display","none");
            ...
            $("#showsupplier").css("display","block");
        }
            ...
            $("#SupplierIDas_chosen").css("display","block");
